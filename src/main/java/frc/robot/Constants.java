...
public final class Constants {
	...
	public static class VisionConstants {
		...
		public static final Transform3d ROBOT_TO_FRONT_CAM_TRANSFORM = new Transform3d(new Translation3d(0.2675, -0.029, 0.1825), new Rotation3d(0.767945, 0, 0));
		public static final String SIDE_CAM_NAME = "CamSide";
		public static final Transform3d ROBOT_TO_SIDE_CAM_TRANSFORM = new Transform3d(new Translation3d(0.13335, 0.2413, 0.15875), new Rotation3d(0, -0.698132, 0));
