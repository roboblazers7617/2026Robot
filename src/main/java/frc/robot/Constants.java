...
public final class Constants {
	...
	public static class VisionConstants {
		...
		public static final Transform3d ROBOT_TO_EBOARD_CAM_TRANSFORM = new Transform3d(new Translation3d(-0.2960878, 0.3098546, 0.5274056), new Rotation3d(0, 0.174533, 0.5 * Math.PI));
